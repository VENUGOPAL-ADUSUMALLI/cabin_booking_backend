...
class UserProfileUpdate:
    ...
    def update_user_profile_interactor(self,username,first_name,last_name,contact_number):
        try:
            self.storage.validate_user_name(username)
        except InvalidUsernameException():
            return self.response.invalid_user_name_exception()
        try:
        ...
        self.storage.update_user_profile(username,first_name, last_name, contact_number)
