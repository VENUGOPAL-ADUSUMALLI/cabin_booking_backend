...
from cabin_booking.storage.dtos import LoginResponseDTO, AccessTokenDTO, RefreshTokenDTO
...
class TestLoginInteractor:
    ...
    def test_user_id(self, user_db_mock, login_response_mock, interactor, user_authentication_mock):
        ...
        login_response_mock.user_login_dto_response.return_value = expected_response
